...
<body>
  ...
  <main id="main" data-aos="fade" data-aos-delay="1500">
      ...
      <div class="container position-relative">
        <div class="row d-flex justify-content-center">
          <div class="col-lg-6 text-center">
            <h2></h2>
            <p>Bienvenue sur notre Plateforme <?php echo $_SESSION['login'];?></p>
    ...
    <section id="contact" class="contact">
      <div id="profile" >
        <img src="<?php echo $_SESSION['img'] ?>" width="300" height="auto" >
<strong>Login : </strong> <span><?php echo $_SESSION['login']?></span>
<strong>email : </strong> <span><?php echo $_SESSION['email']?></span>
<strong>Date de naissance : </strong> <span><?php echo $_SESSION['ddn']?></span>
<a href="edituser.php?id=<?php echo$_SESSION['id'] ?>" >Modifier Mon compte</a>
