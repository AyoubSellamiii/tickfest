...
if (isset($_GET['idd'])) {
    ...
    $listeReponse = $ReponseC->triRéponse();
 }else {
    ...
    <div class="container-fluid d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a href="Reponseliste.php" class="active">Reponse</a></li>
        </ul>
      </nav><!-- .navbar -->
...
<html>
      <form action="" class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
        <div class="input-group">
          <input type="text" name="idd" class="form-control bg-light border-0 small" placeholder="Search for..." aria-label="Search" aria-describedby="basic-addon2">
