...
$prod=$cordoneeC->affichercordo1($_GET['id_cordo']);
    ...
    <body class="sb-nav-fixed">
        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container">
                             <form name="frm"action="Modifiercordofct.php" method="post" novalidate="novalidate">
                                             <?php
foreach($prod as $pro){
...
?>
                                            ...
                                            <div class="form-group">
                                                <label >Numero</label>
                                                <input type="number" class="form-control" name="num" value="<?php echo $pro['Numero'] ?>" >
                                               <input type="hidden" class="form-control" name="id" value="<?php echo $pro['id_cordo'] ?>" >
                                                 <input type="hidden" class="form-control" name="id_paiement" value="<?php echo $pro['id_paiement'] ?>" >
                                                  
                                            </div>
                                            <div class="form-group">
                                                <label >Mail</label>
                                                <input type="email" class="form-control" name="mail" value="<?php echo $pro['adresse_mail'] ?>" >
