                ...
                <div class="app-sidebar">
                    ...
                    <div class="main-sidemenu">
                        ...
                        <ul class="side-menu">
                           ...
                           <a class="side-menu__item" data-bs-toggle="slide" href="index.php"><i class="side-menu__icon fe fe-slack"></i><span class="side-menu__label">Orders</span><i class="angle fe fe-chevron-right"></i></a>
                        ...
                        <div class="page-header">
                            ...
                            <div>
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Order Détails</li>
                                </ol>
                            </div>
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h3 class="card-title">Order Détail</h3>
                                    </div>
                                    <div class="card-body">
                                        <div class="table-responsive">
                                            ...
                                            <?php  foreach ($commandeEvents as $item) {?>
                                           <tr>
                                               <td><img src="<?php echo $item['image'];?>" alt="<?php echo $item['name'];?>"> <?php echo $item['name'];?></td>
                                               <td><?php echo $item['price'];?> DT</td>
                                               <td><?php echo $item['quantity_event'];?></td>
                                               <td> <?php echo intval($item['quantity_event'])*intval($item['price'])?> DT</td>
                                           </tr>
                                           <?php } ?>
                                            ...
                                            <table>
                                                ...
                                                <tr>
                                                    <td>Full Name:</td>
                                                    <td><?php echo $userinfos['login']; ?></td>
                                                </tr>
