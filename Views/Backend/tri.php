                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><i class="fa fa-table"></i><a href="table-partenaire.php">Partenaire</a></li>
                             <li><i class="fa fa-table"></i><a href="">offre</a></li>
                ...
                <div class="row">
                    ...
                    <input class="form-control bg-dark border-0" type="search" placeholder="Search" name="rech">
                                ...
                                <strong class="card-title">Admin</strong>
                                 <strong class="card-title"><a href="tri.php">Trie par date</a></strong>
...
?>
                                            ...
                                            <td><?php echo $pro['date_deb'] ?></td>
                                               <td><?php echo $pro['date_fin'] ?></td>
                                                   <td><?php echo $pro['code_promo'] ?></td>
                                            <td><?php echo $pro['id_partenaire'] ?></td>
                                   ...
                                   <td>     <form method="post" action="supprumeroffre.php">
<input type="submit" value="Supprimer"class="btn btn-primary btn-lg" >
<input type="hidden" value="<?php echo $pro['id_offre'] ?>" name="id_offre">
</form></td>
<td> 
...
<input type="hidden" value="<?php echo $pro['id_offre'] ?>" name="id_offre">
        ...
        <div>
            <button type="button" class="btn btn-primary btn-lg"  style="margin-top:3%;margin-left:5%;border-radius: 5%;">
                <a href="Ajouteroffre.php">Ajouter offre</a>
