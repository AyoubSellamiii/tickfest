...
<strong>HÔTEL LE PALACE GAMMARTH </strong> <span></span>
<strong>19 AVRIL 2023 22H00 - 23H30 </strong> <span></span>

<strong>50Dt</strong> <span></span>
<form method="post" action="formulairepaiemnt.php">
<input type="submit" value="Acheter Ticket"class="btn btn-primary btn-lg" >
<input type="hidden" value="lotfi bouchnak" name="Nom">
<input type="hidden" value="50" name="prix">
</form>
</div>
